<?php
	...
	$sql5 = "select loan_id, fine_amt from book_loans natural join fines where date_in <= due_date";
	$result3 = $con->query($sql5);
		while($row1 = $result3->fetch_assoc())
		{
			$l1=$row1['loan_id'];
			$f1=$row1['fine_amt'];
			$sql6 = "update fines natural join book_loans set fine_amt=0 where date_in <= due_date";
